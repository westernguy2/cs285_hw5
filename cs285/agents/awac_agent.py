...
class AWACAgent(DQNAgent):
    ...
    def estimate_advantage(self, ob_no, ac_na, re_n, next_ob_no, terminal_n, n_actions=10):
        ...
        if self.agent_params['discrete']:
            ...
            #     pass
            vals = self.get_qvals(self.exploitation_critic, ob_no, ac_na)
        else:
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        if (self.t > self.learning_starts
            ...
            explore_weight = 1 #self.explore_weight_schedule
            exploit_weight = 0 #self.exploit_weight_schedule
            ...
            est_advtg = self.estimate_advantage(ob_no, ac_na, re_n, next_ob_no, terminal_n)
            actor_loss = self.eval_policy.update(ob_no, ac_na, est_advtg)
